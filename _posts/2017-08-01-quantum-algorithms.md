...
---
เมื่อหนึ่งปีเต็มที่แล้วถูกชักชวนจากจิรวัฒน์ (CQT, สิงคโปร์) ให้ไปช่วยเขียนหนังสือให้ความรู้เกี่ยวกับคอมพิวเตอร์เชิงควอนตัม ด้วยความช่วยเหลือตรวจแก้จากบรรณาธิการและผู้ร่วมชะตากรรมเขียนคนอื่นๆทำให้สำเร็จออกมาเป็นหนังสือ [*รูป รส กลิ่น เสียง สัมผัส ไอทีควอนตัม (๓): “คอมพิวเตอร์เชิงควอนตัม”*](http://www.ebooks.in.th/ebook/45594/) จนได้ ส่วนที่มีคณิตศาสตร์ที่มากกว่าการนับเลขถูกตัดออกหมดก็เลยอยากจะลงต้นฉบับที่มีคณิตศาสตร์ไว้ ณ ที่นี้เพื่อความเข้าใจคอมพิวเตอร์เชิงควอนตัมที่แม่นยำและลึกซึ้งขึ้นครับ
---
...
[^1]: Thomas Monz et al., “[Realization of a scalable Shor algorithm](http://science.sciencemag.org/content/351/6277/1068)” *Science* 351 1068 (2016).

[^2]: สำหรับผู้รู้ทฤษฎีควอนตัม ที่พูดไปไม่ใช่ความจริงทั้งหมดเพราะมุมนี้สามารถเป็นจำนวนเชิงซ้อนได้! แต่ทุกมุมในบทความนี้เป็นจำนวนจริง

[^3]: จริงๆคือ $\pi/4$ คูณรากที่สองของจำนวนคำตอบที่เป็นไปได้
