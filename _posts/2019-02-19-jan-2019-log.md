...
- [God's Number is 20](https://cube20.org/): the longest shortest sequence to solve a Rubik's cube is 20 moves in the half-turn metric (any non-trivial turn of any face counts as one move).
