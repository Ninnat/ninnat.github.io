...
*Epistemic status: as of December 2020, the part on quantum supremacy is obsoleted in several aspects: having worked on [proposing a new quantum advantage scheme](https://arxiv.org/abs/2012.15825), I now have a better understanding of the intricacies of the argument myself; a pedagogical treatment of the supermacy argument can now be found in Dominik Hangleiter's [PhD thesis](https://arxiv.org/abs/2012.07905).*
...
- Misunderstanding ensued after the Google's announcement went viral (for example, that we now have a fully functional quantum computer that can break codes), which compelled me to write [Google's quantum supremacy FAQ](https://ninnat.github.io/quantum/google-supremacy/) aimed at interested laypeople in Thai.
...
|:--------:|:----:|:--:|:------:|
|Worst-case|[Aaronson'11](https://arxiv.org/abs/1011.3245)<br>[Bremner'10](https://royalsocietypublishing.org/doi/10.1098/rspa.2010.0301)|(Multiplicative)<br>[Aaronson'11](https://arxiv.org/abs/1011.3245)<br>[Bremner'10](https://royalsocietypublishing.org/doi/10.1098/rspa.2010.0301)|Postselection argument|
|Average-case|[Aaronson'11](https://arxiv.org/abs/1011.3245)<br>[Bouland'18](https://arxiv.org/abs/1803.04402)|*Conjectured*<br>(Additive)<br>[Bremner'16](https://arxiv.org/abs/1504.07999)<br>[Boixo'18](https://arxiv.org/abs/1608.00263)|Stockmeyer theorem<br>Random circuits [anticoncentrate](https://arxiv.org/abs/1706.03786)|
...
- [Adaptive quantum state tomography improves accuracy quadratically](https://arxiv.org/abs/1303.0436), Mahler et al 2013
    - [Discontinuities of the quantum Fisher information and the Bures metric](https://arxiv.org/abs/1612.04581), Šafránek 2017
      ...
      Let $G(\epsilon) = \sqrt{\sqrt{\rho}(\rho + \epsilon\Delta)\sqrt{\rho}}$. We will perturbatively calculate the line element $ds^2 = 2(1-\tr G(\epsilon))$ to second order.
      ...
      $$\begin{align}
          ...
          \tr Y  &= - \frac{1}{2} \sum_{jk} \frac{p_k\Delta_{jk}^2}{(p_j + p_k)^2} = - \frac{1}{4} \sum_{j,k} \frac{\Delta_{jk}^2}{p_j + p_k},
      \end{align}$$
      ...
      $\tr X = \tr \Delta/2 = 0$, leaving only the result
      $$\begin{align}
          ds^2 = 2 \left( 1 - \tr\rho - \tr X - \frac{1}{2!}\tr Y - O(\Delta^3) \right) = \frac{1}{4} \sum_{j,k} \frac{\Delta_{jk}^2}{p_j + p_k} + O(\Delta^3)
      \end{align}$$
      ...
      $$\begin{align}
          ds^2 = -\tr \Delta + O(\Delta^2) = \sum_{j=0} \Delta_{jj} + O(\Delta^2).
      \end{align}$$
