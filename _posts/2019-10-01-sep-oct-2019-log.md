...
*Epistemic status: as of December 2020, the part on quantum supremacy is obsoleted in several aspects: a pedagogical treatment of the supermacy argument can now be found in Dominik Hangleiter's [PhD thesis](https://arxiv.org/abs/2012.07905); having worked on [proposing a new quantum advantage scheme](https://arxiv.org/abs/2012.15825), I now have a better understanding of the intricacies of the argument myself.*
